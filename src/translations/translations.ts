...
const translations: Record<LanguageCode, TranslationKeys> = {
  ...
  se: {
    ...
    mondayFriday: "Öppet lördagar augusti ut: 12 – sent",
  ...
  no: {
    ...
    mondayFriday: "Åpent lørdager ut august: 12 – sent",
...
GelatoDescription: "Spør personalet om smak",
  ...
  dk: {
    ...
    mondayFriday: "Åbent lørdage august ud: 12 – sent",
    saturdaySunday: "Lør-Søn: 12:00 - 22:00",
...
GelatoDescription: "Spørg personalet om smag",
  ...
  en: {
    ...
    mondayFriday: "Open Saturdays through August: 12 – late",
...
GelatoDescription: "Ask the staff for flavor",
  ...
  de: {
    ...
    mondayFriday: "Samstags im August geöffnet: 12 – spät",
