...
const translations: Record<LanguageCode, TranslationKeys> = {
  ...
  se: {
    ...
    mondayFriday: "Öppet lördagar augusti ut: 17 – sent",
  ...
  no: {
    ...
    mondayFriday: "Åpent lørdager ut august: 17 – sent",
...
GelatoDescription: "Spør personalet om smak",
  ...
  dk: {
    ...
    mondayFriday: "Åbent lørdage august ud: 17 – sent",
    saturdaySunday: "Lør-Søn: 12:00 - 22:00",
...
GelatoDescription: "Spørg personalet om smag",
  ...
  en: {
    ...
    mondayFriday: "Open Saturdays through August: 17 – late",
...
GelatoDescription: "Ask the staff for flavor",
  ...
  de: {
    ...
    mondayFriday: "Samstags im August geöffnet: 17 – spät",
