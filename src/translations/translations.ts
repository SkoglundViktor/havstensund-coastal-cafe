...
const translations: Record<LanguageCode, TranslationKeys> = {
  ...
  se: {
    ...
    mondayFriday: "Tillfälligt stängt – öppnar igen till midsommar.",
  ...
  iceCreamDescription: "Hallonsorbet/choklad/vanilj/apelsinchoklad",
    ...
    ourHistoryP1: "Behöver nått content här david.",
    ...
    ourHistoryP3: "Idag drivs verksamheten av David, som med sin kärlek till god mat och högklassig service fortsätter att göra Skaldjurscaféet till en av västkustens gastronomiska pärlor.",
  ...
  no: {
    ...
    mondayFriday: "Midlertidig stengt – åpner igjen til sankthans.",
...
iceCreamDescription: "Hindbærsorbet/sjokolade/vanilje/appelsinsjokolade",
    ...
    ourHistoryP3: "I dag drives virksomheten av David, som med sin kjærlighet til god mat og høykvalitetsservice fortsetter å gjøre Skalldyrkafeen til en av vestkystens gastronomiske perler.",
    ourPhilosophyTitle: "Vår Filosofi",
  ...
  dk: {
    ...
    mondayFriday: "Midlertidigt lukket – åbner igen til Sankt Hans.",
    saturdaySunday: "Lør-Søn: 12:00 - 22:00",
...
iceCreamDescription: "Hindbærsorbet/chokolade/vanilje/appelsinchokolade",
    ...
    ourHistoryP3: "I dag drives virksomheden af David, som med deres kærlighed til god mad og førsteklasses service fortsætter med at gøre Skaldyrscaféen til en af vestkystens gastronomiske perler.",
  ...
  en: {
    ...
    mondayFriday: "Temporarily closed – reopening by Midsummer.",
...
iceCreamDescription: "Raspberry sorbet/chocolate/vanilla/orange chocolate",
    ...
    ourHistoryP3: "Today, the business is run by David, who with their love for good food and high-quality service continue to make Skaldjurscaféet one of the West Coast's gastronomic gems.",
  ...
  de: {
    ...
    mondayFriday: "Vorübergehend geschlossen – Wiedereröffnung bis Mittsommer.",
...
iceCreamDescription: "Himbeersorbet/Schokolade/Vanille/Orangen-Schokolade",
    ...
    ourHistoryP3: "Heute wird das Unternehmen David, die mit ihrer Liebe zu gutem Essen und hochwertigem Service Skaldjurscaféet weiterhin zu einem der gastronomischen Juwelen der Westküste machen.",
