  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      await emailjs.send(
        ...
        {
          name: formData.name,            // matchar {{name}} i template
          email: formData.email,          // matchar {{email}} i template
          phone: formData.phone,          // om du har {{phone}} i template
          message: formData.message,      // matchar {{message}} i template
          reply_to: formData.email,       // används för Reply-To i template settings
        },
      ...
      <div className="container mx-auto px-4 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-5 mb-8">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-gray-700">
                    <a href="tel:+46706484748" className="hover:text-coastal-deep-blue">
                      +46 70 648 47 48
                    </a>
                  </p>
                </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <p className="text-gray-700">
                    <a href="mailto:info@skaldjurscafeet.se" className="hover:text-coastal-deep-blue">
                      info@skaldjurscafeet.se
                    </a>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="text-gray-700 grid grid-cols-2 gap-x-2">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6">{t.contactFormInfo}</p>
